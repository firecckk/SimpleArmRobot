...
public class MJPEGStreamDecoder : MonoBehaviour
{
    ...
    [SerializeField] string defaultStreamURL = "http://192.168.31.197:8080/?action=stream";
    ...
    {
        defaultStreamURL = "http://" + ip_addr + ":81/stream";
    }
