 ...
 * 
 * Cam control by sensor fusion:
1. read accelerometer and gyroscope -- deta values
2. apply integral/sum -- cumulative value
3. nomalize accelerometer value. -- eigen vector point to ground.
4. calc rotation of accelerometer value.
5. Kalman filter between accelerometer and gyroscope value.
*/
...
public class SensorFusion : MonoBehaviour
{
    ...
    {
        return filter.GetAcceleratorValue();
    }
    ...
    void Awake()
    {
        ...
        {
            filter = new ComplementaryFilter(.8f, PREDICTION_TIME);
    ...
    public class ComplementaryFilter
    {
		...
		*/
        ...
        public Vector3 GetAcceleratorValue()
        {
            return currentAccelSample.value;
        }
